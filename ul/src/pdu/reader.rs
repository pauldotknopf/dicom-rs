...
pub fn read_pdu(reader: &mut NetStream, max_pdu_length: u32) -> Result<PDU> {
    ...
    match pdu_type {
        0x01 => {
            ...
            Ok(PDU::AssociationRQ(Arc::new(AssociateRQContainer {
                protocol_version,
        ...
        0x02 => {
            ...
            Ok(PDU::AssociationAC(Arc::new(AssociateACContainer {
                protocol_version,
                application_context_name: application_context_name.unwrap(),
                presentation_contexts,
                user_variables,
        ...
        0x03 => {
            ...
            Ok(PDU::AssociationRJ(Arc::new(AssociateRJContainer {
                result: result,
                source: source,
            })))
        }
        0x04 => {
            ...
            Ok(PDU::PData(Arc::new(PDataContainer { data: values })))
        }
        0x05 => {
        ...
        0x07 => {
            ...
            Ok(PDU::AbortRQ(Arc::new(AbortRQContainer { source })))
        }
        _ => {
            let data = read_n(&mut cursor, pdu_length as u64)?;
            Ok(PDU::Unknown(Arc::new(UnknownContainer { pdu_type, data })))
        }
    }
}
